...
@Model
final class LuciaTouchEvent: Codable, Identifiable, Equatable {
	var id: UUID  // Equivalent to auto-generated primary key (use UUID for simplicity in SwiftData)
	...
	private(set) var timestamp: Double  // TimeInterval (seconds since boot; adapt if needed)
	private(set) var type: String
	private(set) var rawX: Float
	private(set) var rawY: Float
	private(set) var pressure: Float
	private(set) var size: Float
	private(set) var velocityX: Float?
	private(set) var velocityY: Float?
	private(set) var distanceX: Float?
	private(set) var distanceY: Float?
	...
	@MainActor static func create(touch: UITouch, in view: UIView?) -> LuciaTouchEvent {
	...
	@MainActor static func createFling(touch: UITouch, in view: UIView?, velocity: CGPoint?) -> LuciaTouchEvent {
	...
	@MainActor static func createScroll(touch: UITouch, in view: UIView?, distance: CGPoint?) -> LuciaTouchEvent {
		let location = touch.location(in: view)
		// TODO: pass in sessionID
		return LuciaTouchEvent(
			sessionID: "",
